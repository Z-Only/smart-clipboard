<template>
  ...
  >
    <div
      class="bg-background rounded-lg shadow-xl w-[450px] max-h-[70vh] flex flex-col border border-border"
    >
      ...
      <div class="flex-1 overflow-y-auto p-4 space-y-3">
        ...
        <div class="mt-4">
          ...
          <div
            class="p-3 rounded-md bg-muted text-sm font-mono whitespace-pre-wrap break-all max-h-32 overflow-y-auto"
          >
            {{ renderedPreview }}
          </div>
        </div>
