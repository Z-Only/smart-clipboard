<template>
  ...
  >
    <div class="w-80 bg-background border-l border-border shadow-xl flex flex-col h-full animate-in slide-in-from-right">
      <!-- Header -->
      <div class="flex items-center justify-between p-4 border-b border-border">
        ...
        <div class="flex items-center gap-1">
          <button
            ...
            @click="handleRefresh"
          >
            <svg class="h-4 w-4" :class="{ 'animate-spin': isReclustering }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
