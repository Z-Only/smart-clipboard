<template>
  <div class="fixed inset-0 z-[80] flex items-center justify-center bg-background/95 backdrop-blur-sm">
    <div class="w-[360px] rounded-xl border border-border bg-card p-6 shadow-2xl">
      ...
      <div class="space-y-3">
        ...
        <button class="w-full h-10 rounded-md bg-primary text-primary-foreground text-sm font-medium" @click="submitPassword">
